    ...
    <div className="home-page container">
      ...
      <section className="about-intro-grid">
        ...
        <div className="about-content">
          <h2>About Me</h2>
          <p>
            welcome to my blog! i'm vijay, a recent berkeley grad and software
            engineer based in the bay area. as most of this current generation,
            ai has fried my brain beyond belief over the past few years.
            althought the amount of information im consuming has increased, my
            ability to process and retain it has decreased.
          </p>
          <p>
